...
### Source (by order of priority)
-   `kratt / fusebox`: A command from the mFRR market. **These commands are mandatory and have the highest priority.**
-   `Q`: A command generated by Qilowatt optimizing the battery SOC for better FRR market participation opportunities
